...
value_override = [
    ...
    "backend.secrets.basicAuth.value=%s" % os.environ["BASIC_AUTH"],
    ...
    "frontend.secrets.viteAuth.VITE_AUTH_USERNAME.value=%s" % os.environ["VITE_AUTH_USERNAME"],
    "frontend.secrets.viteAuth.VITE_AUTH_PASSWORD.value=%s" % os.environ["VITE_AUTH_PASSWORD"],
    # variables
