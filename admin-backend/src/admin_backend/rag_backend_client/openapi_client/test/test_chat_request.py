...
class TestChatRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ChatRequest:
        ...
        if include_optional:
            return ChatRequest(
                history = admin_backend.rag_backend_client.openapi_client.models.chat_history.chat_history(
                    messages = admin_backend.rag_backend_client.openapi_client.models.chat_history_message.chat_history_message(
                        role = 'user', 
                        message = '', ), ),
                message = ''
            )
