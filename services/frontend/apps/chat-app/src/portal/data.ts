...
// NOTE: The URLs below point to paths under /assets which should be served as static files.
// If these assets are not yet available in the built app, the sidebar will still show entries
// but the links may return 404. To enable downloads, copy the PDFs from tmp/webportal/assets
// into apps/chat-app/public/assets preserving the directory layout.
const lboFiles = [
...
export const addresses: AddressData[] = [
  {
    original: "Besseringen, Schinderwaldstraße 1",
    parcel: "1234/567",
    gemarkung: "Besseringen",
    plan: planFiles[0],
    planStatus: "available",
    festsetzungen: festsetzungenFiles[0],
    lbo: lboFiles[0],
  },
  {
    original: "Besseringen, Schinderwaldstraße 2",
    parcel: "1234/568",
    gemarkung: "Besseringen",
    plan: planFiles[0],
    planStatus: "available",
  ...
  {
    original: "Besseringen, Schinderwaldstraße 3",
    parcel: "1234/569",
    gemarkung: "Besseringen",
    plan: planFiles[0],
    planStatus: "available",
  ...
  {
    original: "Saarbrücken, Waldwieserstraße 10",
    parcel: "2345/678",
    gemarkung: "Saarbrücken",
    plan: planFiles[1],
    planStatus: "available",
    festsetzungen: festsetzungenFiles[1],
    lbo: lboFiles[1],
  },
  {
    original: "Saarbrücken, Waldwieserstraße 11",
    parcel: "2345/679",
    gemarkung: "Saarbrücken",
    plan: planFiles[1],
    planStatus: "available",
  ...
  {
    original: "Saarbrücken, Waldwieserstraße 12",
    parcel: "2345/680",
    gemarkung: "Saarbrücken",
    plan: planFiles[1],
    planStatus: "available",
  ...
  {
    original: "Merzig, Innenstadt Süd 15",
    parcel: "4567/890",
    gemarkung: "Merzig",
    plan: planFiles[2],
    planStatus: "available",
    festsetzungen: festsetzungenFiles[2],
    lbo: lboFiles[3],
  },
  {
    original: "Merzig, Innenstadt Süd 16",
    parcel: "4567/891",
    gemarkung: "Merzig",
    plan: planFiles[2],
    planStatus: "available",
  ...
  {
    original: "Merzig, Innenstadt Süd 17",
    parcel: "4567/892",
    gemarkung: "Merzig",
    plan: planFiles[2],
    planStatus: "available",
  ...
  {
    original: "Saarbrücken, Südkern Tangente 3",
    parcel: "6789/012",
    gemarkung: "Saarbrücken",
    plan: planFiles[3],
    planStatus: "available",
    festsetzungen: festsetzungenFiles[3],
    lbo: lboFiles[5],
  },
  {
    original: "Saarbrücken, Südkern Tangente 4",
    parcel: "6789/013",
    gemarkung: "Saarbrücken",
    plan: planFiles[3],
    planStatus: "available",
  ...
  {
    original: "Saarbrücken, Südkern Tangente 5",
    parcel: "6789/014",
    gemarkung: "Saarbrücken",
    plan: planFiles[3],
    planStatus: "available",
  ...
  {
    original: "Besseringen, Armenberg 8",
    parcel: "0123/456",
    gemarkung: "Besseringen",
    plan: planFiles[5],
    planStatus: "available",
  ...
  {
    original: "Besseringen, Armenberg 9",
    parcel: "0123/457",
    gemarkung: "Besseringen",
    plan: planFiles[5],
    planStatus: "available",
  ...
  {
    original: "Besseringen, Armenberg 10",
    parcel: "0123/458",
    gemarkung: "Besseringen",
    plan: planFiles[5],
    planStatus: "available",
